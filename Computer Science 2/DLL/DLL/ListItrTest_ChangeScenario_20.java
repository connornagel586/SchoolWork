 ...
 * List Iterator Tests for Change Scenario 20: [A, B] -> addToFront(C) -> [C, A, B]
 * 
 * @author Connor Nagel	
 */
public class ListItrTest_ChangeScenario_20
{
	...
	private final Integer FIRST = TestCase.C;
	// Middle element in list
	private final Integer MIDDLE = TestCase.A;
	// Last element in list 
	private final Integer LAST = TestCase.B;	
	...
	/*********Call next() twice, previous(), add() and previous(), then run tests**********/
	/**
	...
	/*********Call next() three times, and previous(), then run tests**********/
	/**
	 * Test: new ListIterator, call next() three times, previous(); test hasPrevious() - whether there's a previous element in the ListIterator list
	 * Expected Result: true
	 */
	@Test
	...
	/*********Call next() call next() three times, previous() and add(), then run tests**********/
	/**
	...
	/*********Call next() call next() three times, and then add(), then run tests**********/
	/**
	 * Test: new ListIterator, call next() three times, and then add(); test hasPrevious() - whether there's a previous element in the ListIterator list
	 * Expected Result: true
	 */
	@Test
	...
	/**
	 * Test: new ListIterator, call next() three times, and then add(); test previous() - returns ref to previous element in the ListIterator list
	 * Expected Result: No exception
	 */
	@Test
	...
	/**
	 * Test: new ListIterator, call next() three times, and then add(); test add() - adds new element to the ListIterator list
	 * Expected Result: No exception
	 */
	@Test
	...
	/**
	 * Test: new ListIterator,  call next() three times, and then add(); test nextIndex() - index of next element in the ListIterator list
	 * Expected Result: 2
	 */
	@Test
	...
	{
		itr = TestCase.initListItr(list, TestCase.ListItrState.nextNextNextAdd);
		TestCase.nextIndex(itr, 4); 
	}
	
	/**
	 * Test: new ListIterator,  call next() three times, and then add(); test previousIndex() - index of previous element in the ListIterator list
	 * Expected Result: 1
	 */
	@Test
	...
	{
		itr = TestCase.initListItr(list, TestCase.ListItrState.nextNextNextAdd);
		TestCase.previousIndex(itr, 3); 
	}

	/**
	 * Test: new ListIterator, call next() three times, and then add(); test set() - sets element in the ListIterator list
	 * Expected Result: IllegalStateException
	 */
	@Test(expectedExceptions = IllegalStateException.class)
