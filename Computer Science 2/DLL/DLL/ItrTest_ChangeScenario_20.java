 ...
 * Iterator Tests for Change Scenario 20: [A, B] -> addToFront(C) -> [C, A, B]
 * 
 * @author Connor Nagel
 */
public class ItrTest_ChangeScenario_20
{
	...
	private static final Integer FIRST = TestCase.C;
	// Middle element in list
	private static final Integer MIDDLE = TestCase.A;
	...
	/**
	 * Test: new Iterator, call next(), next(), next(); test remove() - tries to remove last element returned by next in the Iterator list
	 * Expected Result: IllegalStateException
	 */
	@Test 
	...
	/**
	 * Test: new Iterator, call next(), remove(), next(); test next() - whether there's a next element in the Iterator list
	 * Expected Result: NoSuchElementException
	 */
	@Test(expectedExceptions = NoSuchElementException.class)
	...
	/**
	 * Test: new Iterator, call next(), remove(), next(); test remove() - whether there's a next element in the Iterator list
	 * Expected Result: IllegalStateException
	 */
	@Test
