...
public class CircuitBoard {
	 ...
	 *             valid input file
	 */
	public CircuitBoard(String filename) throws InvalidFileFormatException,
		...
		try {
			...
			while (fileScan.hasNextLine()) {
				...
				scannedLine = new Scanner(currentLine);

				while (scannedLine.hasNext()) {
					board[row][col] = scannedLine.next().charAt(0);
					if (board[row][col] == '1') {
			...
			System.out.println(e + "This file is incorrently formatted");
